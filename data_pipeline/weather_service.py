...
def fetch_nasa_power_data(lat, lon, days_back=120):
    """
    Fetch recent rainfall and temperature data from NASA POWER for a given
    lat/lon. Returns averaged season-relevant stats, or None on failure.
    """
